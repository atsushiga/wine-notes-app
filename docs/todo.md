...
- [ ] **(@Antigravity)** ダークモード表示対応
    ...
    - [x] 統計ページ
    - [ ] 設定ページ
- [x] **(@Antigravity)** 地名のサジェスチョン機能
    - [x] 地名DBのサジェスチョン機能
    - [x] 地名DBの日本語サジェスチョン機能
    - [x] AI検索結果の地名サジェスチョンの反映
    - [x] 地名DBの日本語化
    - [x] 地名の日英併記
- [ ] **(@Antigravity)** 地名DBの階層化
...
- [x] 再編集時の日付の入力
- [x] 参考URLフォームの作成
- [x] AI情報検索の際、公式URLがある場合はそちらを参照するようにする
- [x] AI情報検索の際、産地も参照するようにする

### 8. ユーザー管理
- [x] ログアウト機能の実装
- [x] ユーザー情報(メールアドレス、パスワード)変更機能の実装
- [x] ユーザー情報の表示機能の実装
- [x] メールアドレス変更時の確認フロー明確化
- [x] パスワードリセット導線の実装
- [x] ユーザー情報削除機能の実装
- [x] ユーザー登録機能の実装
- [ ] ユーザータイプの追加(premium, free, 特権)
- [ ] ログイン画面にサイト名とロゴを追加
...
- [x] 認証必須化とAPI保護
- [x] 画像アクセスの本人限定化
- [x] 利用量制限と監視用 `usage_events` の追加
- [x] 利用規約、プライバシーポリシー、問い合わせページの追加
- [x] データエクスポート機能の追加
- [x] 退会/アカウント削除導線の追加
- [x] パスワードリセット導線の追加
- [x] 404、エラー、ローディング画面の整備
- [x] AI生成画像と出典画像の表示ルール明確化
- [x] `robots.txt` と `sitemap.xml` の追加
- [x] README、Runbook、監視SQLの整備
- [x] 管理者用利用量サマリーAPIの追加
- [x] アクセシビリティの基本導線追加
